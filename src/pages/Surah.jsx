...
const VerseRow = ({
    ...
    setActiveTafsir, isTafsirFetching, tafsirId, showPageDivider
}) => {
    ...
    }, [inView, chapter, verse.verse_key, addRecentlyRead]);
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
                        ...
                        <button
                            ...
                            onClick={() => setBookmark(verse.verse_key, chapter.name_simple)}
