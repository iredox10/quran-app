...
export default function AlertModal() {
    const { globalAlert, setGlobalAlert } = useAppStore();
                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center text-center relative z-10">
                            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--h-teal-soft)] text-[var(--h-teal)]">
                            ...
                            <button
                                onClick={() => setGlobalAlert(null)}
                                className="w-full rounded-xl bg-[var(--h-teal)] px-6 py-3.5 font-bold text-white transition-all hover:bg-[var(--h-teal-mid)] active:scale-95 shadow-md"
                            >
                                Got it
                            </button>
                        </div>
